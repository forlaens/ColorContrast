(function () {
	...
	var translations = {
		...
		kl: {
			...
			title: 'Assimi contrast-imik misissuineq',
			lede: 'Allakkat imaluunniit UI-p qalipaataat assip qaavani naammattumik contrast-eqarnersut misissukkit.',
			chooseImage: 'Assi toqqaruk',
			uploadCopy: 'PNG, JPG, GIF imaluunniit SVG. Fiili browserinniiginnassaaq.',
			loadImage: 'Assi ikkuguk',
			introTitle: 'Qanoq atorneqassava',
			stepUploadTitle: 'Assi upload-eruk',
			stepUploadCopy: 'Screenshot, design-export imaluunniit imarisami assi atoruk.',
			stepColorTitle: 'Qalipaat testigassaq toqqaruk',
			stepColorCopy: 'Allakkat imaluunniit UI-p qalipaataa testigassaq toqqaruk.',
			stepRunTitle: 'Testi aallartiguk',
			stepRunCopy: 'Preview-mi sumiiffiit contrast-imut piumasaqaatinik naammassinninngitsut ersersinneqassapput.',
